...
class ConvBlock3c(nn.Module):
    def __init__(self, in_channels, out_channels):
        super(ConvBlock3c, self).__init__()
        ...
        self.cot = CoTAttention(dim=out_channels, kernel_size=3)
...
class DeepADN_PLUS(nn.Module):
    ...
    def __init__(self, num_class, input_size, dropout=0.1, extract_embedding: bool = True):
        ...
        self.conv_block4 = ConvBlock3c(in_channels=256, out_channels=512)
